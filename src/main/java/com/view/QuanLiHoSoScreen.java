...
public class QuanLiHoSoScreen {
    ...
    @FXML
    private TableColumn<NhanVienDTO, String> colMaNhanVien, colTenNhanVien, colLoaiNhanVien, colViTri, colTrangThaiHoatDong, colQuyenTruyCap;

    @FXML
    private TableColumn<NhanVienDTO, Void> colAction;
    ...
    public void initialize() {
        ...
        colQuyenTruyCap.setCellValueFactory(new PropertyValueFactory<>("quyenTruyCap"));
    ...
    @FXML
    private void kichNutThem(ActionEvent event) {
    try {
